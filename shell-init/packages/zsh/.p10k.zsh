# Generated by Powerlevel10k configuration wizard on 2026-05-11 at 17:22 CST.
...
# flat heads, flat tails, 2 lines, dotted, full frame, light-ornaments, sparse,
...
() {
  ...
  # mise version manager (https://mise.jdx.dev/) — replaces asdf segment
  # Ref: https://github.com/romkatv/powerlevel10k/issues/2212
  function prompt_mise() {
    ...
    for plugin in ${(k)plugins}; do
      ...
      # Map mise tool names to p10k icon / color keys
      case $tool in
        GO) tool=GOLANG ;;
        NODE) tool=NODEJS ;;
      esac
  ...
  typeset -g POWERLEVEL9K_MISE_GOLANG_FOREGROUND=0
  typeset -g POWERLEVEL9K_MISE_GOLANG_BACKGROUND=4
  typeset -g POWERLEVEL9K_MISE_NODEJS_FOREGROUND=0
